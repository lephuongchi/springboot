...
import web.model.UploadFileResponse;
import web.service.DocumentStorageService;
...
public class DocumentController {
    ...
    @GetMapping("/downloadFileApi")
    public ResponseEntity<Resource> downloadFileApi(@RequestHeader(value = "userId") String userId,
                                                    @RequestHeader(value="docType") String docType,
                                                    HttpServletRequest request) {
